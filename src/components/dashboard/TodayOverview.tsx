...
const services = [
  { label: "Morgon", span: "06:00–11:30", covers: 38 },
  { label: "Lunch", span: "11:30–17:00", covers: 74 },
  { label: "Kväll", span: "17:00–02:30", covers: 112 },
];
...
export function TodayOverview() {
  ...
  const pending = data.bookings.filter((b) => b.status === "väntar");
  const special = data.bookings.filter((b) => b.note || b.tags.length > 0).slice(0, 4);
