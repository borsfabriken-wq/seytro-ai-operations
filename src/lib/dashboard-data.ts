...
export const dashboardData: Record<Venue, VenueData> = {
  restaurang: {
    ...
    units: [
      ...
      { id: "t40", label: "40", seats: 2, status: "ledigt", zone: "Uteservering", x: 8, y: 87, shape: "rund" },
      { id: "t41", label: "41", seats: 2, status: "ledigt", zone: "Uteservering", x: 18, y: 87, shape: "rund" },
      { id: "t42", label: "42", seats: 2, status: "ledigt", zone: "Uteservering", x: 28, y: 87, shape: "rund" },
      { id: "t43", label: "43", seats: 2, status: "ledigt", zone: "Uteservering", x: 38, y: 87, shape: "rund" },
      { id: "t44", label: "44", seats: 2, status: "ledigt", zone: "Uteservering", x: 48, y: 87, shape: "rund" },
      { id: "t45", label: "45", seats: 2, status: "ledigt", zone: "Uteservering", x: 58, y: 87, shape: "rund" },
      { id: "t50", label: "50", seats: 2, status: "ledigt", zone: "Uteservering", x: 8, y: 97, shape: "lounge" },
      { id: "t55", label: "55", seats: 2, status: "ledigt", zone: "Uteservering", x: 16, y: 97, shape: "lounge" },
      { id: "t60", label: "60", seats: 2, status: "ledigt", zone: "Uteservering", x: 24, y: 97, shape: "lounge" },
      { id: "t61", label: "61", seats: 2, status: "ledigt", zone: "Uteservering", x: 32, y: 97, shape: "lounge" },
      { id: "t62", label: "62", seats: 2, status: "ledigt", zone: "Uteservering", x: 40, y: 97, shape: "lounge" },
      { id: "t63", label: "63", seats: 2, status: "ledigt", zone: "Uteservering", x: 48, y: 97, shape: "lounge" },
      { id: "t64", label: "64", seats: 2, status: "ledigt", zone: "Uteservering", x: 56, y: 97, shape: "lounge" },
      { id: "t65", label: "65", seats: 2, status: "ledigt", zone: "Uteservering", x: 64, y: 97, shape: "lounge" },
      { id: "t66", label: "66", seats: 2, status: "ledigt", zone: "Uteservering", x: 72, y: 97, shape: "lounge" },
    ],
    guests: [
