...
export const dashboardData: Record<Venue, VenueData> = {
  restaurang: {
    ...
    units: [
      ...
      { id: "t73", label: "73", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 35, shape: "fyrkant" },
      { id: "t72", label: "72", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 26, shape: "fyrkant" },
      { id: "t71", label: "71", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 17, shape: "fyrkant" },
      { id: "t70", label: "70", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 8, shape: "fyrkant" },
      { id: "t74", label: "74", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 44, shape: "fyrkant" },
      { id: "t75", label: "75", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 53, shape: "fyrkant" },
      { id: "t76", label: "76", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 62, shape: "fyrkant" },
      { id: "t77", label: "77", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 71, shape: "fyrkant" },
