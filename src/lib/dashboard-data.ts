...
export const dashboardData: Record<Venue, VenueData> = {
  restaurang: {
    ...
    units: [
      { id: "t1", label: "1", seats: 2, status: "upptaget", guest: "Ek", until: "19:15", zone: "Matsalen", x: 20, y: 12, shape: "fyrkant" },
      { id: "t2", label: "2", seats: 2, status: "ledigt", zone: "Matsalen", x: 30, y: 12, shape: "fyrkant" },
      { id: "t3", label: "3", seats: 2, status: "upptaget", guest: "Petter Ask", until: "21:00", zone: "Matsalen", x: 40, y: 12, shape: "fyrkant" },
      { id: "t4", label: "4", seats: 2, status: "ledigt", zone: "Matsalen", x: 50, y: 12, shape: "fyrkant" },
      { id: "t5", label: "5", seats: 2, status: "upptaget", guest: "Marcus Ehn", until: "19:30", zone: "Matsalen", x: 20, y: 26, shape: "fyrkant" },
      { id: "t6", label: "6", seats: 2, status: "ledigt", zone: "Matsalen", x: 30, y: 26, shape: "fyrkant" },
      { id: "t7", label: "7", seats: 2, status: "ledigt", zone: "Matsalen", x: 40, y: 26, shape: "fyrkant" },
      { id: "t8", label: "8", seats: 2, status: "upptaget", guest: "Sara Holmberg", until: "20:15", zone: "Matsalen", x: 50, y: 26, shape: "fyrkant" },
      { id: "t11", label: "11", seats: 4, status: "ledigt", zone: "Bar", x: 78, y: 26, shape: "fyrkant" },
      { id: "t12", label: "12", seats: 4, status: "upptaget", guest: "Familjen Lindqvist", until: "19:00", zone: "Bar", x: 85, y: 26, shape: "fyrkant" },
      { id: "t9", label: "9", seats: 2, status: "ledigt", zone: "Bar", x: 64, y: 26, shape: "fyrkant" },
      { id: "t10", label: "10", seats: 2, status: "upptaget", guest: "Holm", until: "19:00", zone: "Bar", x: 71, y: 26, shape: "fyrkant" },
      { id: "bar", label: "BAR", seats: 18, status: "ledigt", zone: "Bar", x: 74, y: 12, shape: "bar" },
      { id: "t200", label: "200", seats: 2, status: "ledigt", zone: "Lounge", x: 68, y: 42, shape: "lounge" },
      { id: "t201", label: "201", seats: 2, status: "ledigt", zone: "Lounge", x: 76, y: 42, shape: "lounge" },
      { id: "t202", label: "202", seats: 2, status: "ledigt", zone: "Lounge", x: 84, y: 42, shape: "lounge" },
      { id: "t203", label: "203", seats: 2, status: "ledigt", zone: "Lounge", x: 92, y: 42, shape: "lounge" },
      { id: "t204", label: "204", seats: 2, status: "ledigt", zone: "Lounge", x: 68, y: 52, shape: "lounge" },
      { id: "t205", label: "205", seats: 2, status: "ledigt", zone: "Lounge", x: 76, y: 52, shape: "lounge" },
      { id: "t206", label: "206", seats: 2, status: "ledigt", zone: "Lounge", x: 84, y: 52, shape: "lounge" },
      { id: "t207", label: "207", seats: 2, status: "ledigt", zone: "Lounge", x: 92, y: 52, shape: "lounge" },
      { id: "t208", label: "208", seats: 2, status: "ledigt", zone: "Lounge", x: 68, y: 62, shape: "lounge" },
      { id: "t209", label: "209", seats: 2, status: "ledigt", zone: "Lounge", x: 76, y: 62, shape: "lounge" },
      { id: "t21", label: "21", seats: 2, status: "ledigt", zone: "Matsalen", x: 30, y: 40, shape: "fyrkant" },
      { id: "t20", label: "20", seats: 2, status: "upptaget", guest: "Nordea", until: "21:00", zone: "Matsalen", x: 20, y: 40, shape: "fyrkant" },
      { id: "t23", label: "23", seats: 2, status: "ledigt", zone: "Matsalen", x: 50, y: 40, shape: "fyrkant" },
      { id: "t22", label: "22", seats: 2, status: "upptaget", guest: "Melanders", until: "23:00", zone: "Matsalen", x: 40, y: 40, shape: "fyrkant" },
      { id: "t25", label: "25", seats: 2, status: "upptaget", guest: "Lisa Ahl", until: "14:30", zone: "Matsalen", x: 30, y: 54, shape: "fyrkant" },
      { id: "t24", label: "24", seats: 2, status: "ledigt", zone: "Matsalen", x: 20, y: 54, shape: "fyrkant" },
      { id: "t28", label: "28", seats: 2, status: "ledigt", zone: "Matsalen", x: 60, y: 54, shape: "fyrkant" },
      { id: "t27", label: "27", seats: 2, status: "ledigt", zone: "Matsalen", x: 50, y: 54, shape: "fyrkant" },
      { id: "t26", label: "26", seats: 2, status: "ledigt", zone: "Matsalen", x: 40, y: 54, shape: "fyrkant" },
      { id: "t100", label: "100", seats: 8, status: "ledigt", zone: "Matsalen", x: 20, y: 72, shape: "rund" },
      { id: "t30", label: "30", seats: 6, status: "upptaget", guest: "Ahl", until: "20:00", zone: "Matsalen", x: 30, y: 72, shape: "rund" },
      { id: "t31", label: "31", seats: 7, status: "ledigt", zone: "Matsalen", x: 40, y: 72, shape: "rund" },
      { id: "t32", label: "32", seats: 6, status: "upptaget", guest: "Wallgren", until: "19:30", zone: "Matsalen", x: 50, y: 72, shape: "rund" },
      { id: "t33", label: "33", seats: 6, status: "ledigt", zone: "Matsalen", x: 60, y: 72, shape: "rund" },
      { id: "t34", label: "34", seats: 6, status: "upptaget", guest: "Anna Wiklund", until: "21:30", zone: "Matsalen", x: 70, y: 72, shape: "rund" },
      { id: "t73", label: "73", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 43, shape: "fyrkant" },
      { id: "t72", label: "72", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 32, shape: "fyrkant" },
      { id: "t71", label: "71", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 21, shape: "fyrkant" },
      { id: "t70", label: "70", seats: 4, status: "ledigt", zone: "Fönster", x: 6, y: 10, shape: "fyrkant" },
      { id: "t74", label: "74", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 54, shape: "fyrkant" },
      { id: "t75", label: "75", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 65, shape: "fyrkant" },
      { id: "t76", label: "76", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 76, shape: "fyrkant" },
      { id: "t77", label: "77", seats: 2, status: "ledigt", zone: "Fönster", x: 6, y: 87, shape: "fyrkant" },
      { id: "t40", label: "40", seats: 2, status: "ledigt", zone: "Uteservering", x: 16, y: 87, shape: "rund" },
      { id: "t41", label: "41", seats: 2, status: "ledigt", zone: "Uteservering", x: 26, y: 87, shape: "rund" },
      { id: "t42", label: "42", seats: 2, status: "ledigt", zone: "Uteservering", x: 36, y: 87, shape: "rund" },
      { id: "t43", label: "43", seats: 2, status: "ledigt", zone: "Uteservering", x: 46, y: 87, shape: "rund" },
      { id: "t44", label: "44", seats: 2, status: "ledigt", zone: "Uteservering", x: 56, y: 87, shape: "rund" },
      { id: "t45", label: "45", seats: 2, status: "ledigt", zone: "Uteservering", x: 66, y: 87, shape: "rund" },
      { id: "t50", label: "50", seats: 2, status: "ledigt", zone: "Uteservering", x: 16, y: 97, shape: "lounge" },
      { id: "t55", label: "55", seats: 2, status: "ledigt", zone: "Uteservering", x: 24, y: 97, shape: "lounge" },
      { id: "t60", label: "60", seats: 2, status: "ledigt", zone: "Uteservering", x: 32, y: 97, shape: "lounge" },
      { id: "t61", label: "61", seats: 2, status: "ledigt", zone: "Uteservering", x: 40, y: 97, shape: "lounge" },
      { id: "t62", label: "62", seats: 2, status: "ledigt", zone: "Uteservering", x: 48, y: 97, shape: "lounge" },
      { id: "t63", label: "63", seats: 2, status: "ledigt", zone: "Uteservering", x: 56, y: 97, shape: "lounge" },
      { id: "t64", label: "64", seats: 2, status: "ledigt", zone: "Uteservering", x: 64, y: 97, shape: "lounge" },
      { id: "t65", label: "65", seats: 2, status: "ledigt", zone: "Uteservering", x: 72, y: 97, shape: "lounge" },
      { id: "t66", label: "66", seats: 2, status: "ledigt", zone: "Uteservering", x: 80, y: 97, shape: "lounge" },
    ],
    guests: [
